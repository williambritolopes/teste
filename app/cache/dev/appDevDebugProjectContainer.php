...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getAssetic_AssetManagerService()
    {
        ...
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\ConfigurationResource(array('jquery' => array(0 => array(0 => ($this->targetDirs[2].'/../vendor/components/jquery/jquery-3.2.1.js')), 1 => array(), 2 => array()), 'bootstrap_js' => array(0 => array(0 => ($this->targetDirs[2].'/../vendor/twbs/bootstrap/dist/js/bootstrap.js')), 1 => array(), 2 => array()), 'bootstrap_css' => array(0 => array(0 => ($this->targetDirs[2].'/../vendor/twbs/bootstrap/dist/css/bootstrap.css'), 1 => ($this->targetDirs[2].'/../vendor/twbs/bootstrap/dist/css/bootstrap-theme.css')), 1 => array(0 => 'cssrewrite'), 2 => array()), 'bootstrap_glyphicons_ttf' => array(0 => array(0 => ($this->targetDirs[2].'/../vendor/twbs/bootstrap/dist/fonts/glyphicons-halflings-regular.ttf')), 1 => array(), 2 => array('output' => 'fonts/glyphicons-halflings-regular.ttf')), 'bootstrap_glyphicons_eot' => array(0 => array(0 => ($this->targetDirs[2].'/../vendor/twbs/bootstrap/dist/fonts/glyphicons-halflings-regular.eot')), 1 => array(), 2 => array('output' => 'fonts/glyphicons-halflings-regular.eot')), 'bootstrap_glyphicons_svg' => array(0 => array(0 => ($this->targetDirs[2].'/../vendor/twbs/bootstrap/dist/fonts/glyphicons-halflings-regular.svg')), 1 => array(), 2 => array('output' => 'fonts/glyphicons-halflings-regular.svg')), 'bootstrap_glyphicons_woff' => array(0 => array(0 => ($this->targetDirs[2].'/../vendor/twbs/bootstrap/dist/fonts/glyphicons-halflings-regular.woff')), 1 => array(), 2 => array('output' => 'fonts/glyphicons-halflings-regular.woff')))), 'config');
        ...
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'FOSRestBundle', ($this->targetDirs[2].'/Resources/FOSRestBundle/views'), '/\\.[^.]+\\.twig$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'FOSRestBundle', ($this->targetDirs[3].'/vendor/friendsofsymfony/rest-bundle/Resources/views'), '/\\.[^.]+\\.twig$/'))), 'twig');
        ...
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'EinsteinBundle', ($this->targetDirs[2].'/Resources/EinsteinBundle/views'), '/\\.[^.]+\\.twig$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'EinsteinBundle', ($this->targetDirs[3].'/src/EinsteinBundle/Resources/views'), '/\\.[^.]+\\.twig$/'))), 'twig');
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => 8889, 'dbname' => 'einsteinbd', 'user' => 'william', 'password' => 'root', 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $c, array());
    }
    ...
    {
        $a = new \Doctrine\ORM\Mapping\Driver\SimplifiedXmlDriver(array(($this->targetDirs[3].'/src/EinsteinBundle/Resources/config/doctrine') => 'EinsteinBundle\\Entity'));
        $a->setGlobalBasename('mapping');

        $b = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $b->addDriver($a, 'EinsteinBundle\\Entity');

        $c = new \Doctrine\ORM\Configuration();
        $c->setEntityNamespaces(array('EinsteinBundle' => 'EinsteinBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_d439c311e0fd5ef40f37034f95d99483339be75989552c141e6acb5c468c45d9');
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/src/EinsteinBundle/Resources/views'), 'Einstein');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('384ced882fa08404b511e3b69923f22c98ae0ed4');
    }
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('59a96bdfa96a15.01864459')), true);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'EinsteinBundle' => 'EinsteinBundle\\EinsteinBundle',
            ...
            'kernel.bundles_metadata' => array(
                ...
                'EinsteinBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'/src/EinsteinBundle'),
                    'namespace' => 'EinsteinBundle',
                ),
                'DebugBundle' => array(
                    'parent' => NULL,
            ...
            'secret' => '384ced882fa08404b511e3b69923f22c98ae0ed4',
            'locale' => 'en',
            ...
            'kernel.secret' => '384ced882fa08404b511e3b69923f22c98ae0ed4',
