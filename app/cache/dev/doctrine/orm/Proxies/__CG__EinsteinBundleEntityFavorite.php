...
class Favorite extends \EinsteinBundle\Entity\Favorite implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'EinsteinBundle\\Entity\\Favorite' . "\0" . 'created', '' . "\0" . 'EinsteinBundle\\Entity\\Favorite' . "\0" . 'updated', '' . "\0" . 'EinsteinBundle\\Entity\\Favorite' . "\0" . 'deleted', '' . "\0" . 'EinsteinBundle\\Entity\\Favorite' . "\0" . 'id', '' . "\0" . 'EinsteinBundle\\Entity\\Favorite' . "\0" . 'user', '' . "\0" . 'EinsteinBundle\\Entity\\Favorite' . "\0" . 'magazine'];
        }
