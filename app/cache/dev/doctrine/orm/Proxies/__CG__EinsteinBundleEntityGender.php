 ...
 */
class Gender extends \EinsteinBundle\Entity\Gender implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'EinsteinBundle\\Entity\\Gender' . "\0" . 'gender', '' . "\0" . 'EinsteinBundle\\Entity\\Gender' . "\0" . 'createdDate', '' . "\0" . 'EinsteinBundle\\Entity\\Gender' . "\0" . 'updateDate', '' . "\0" . 'EinsteinBundle\\Entity\\Gender' . "\0" . 'deletedDate', '' . "\0" . 'EinsteinBundle\\Entity\\Gender' . "\0" . 'id'];
        }
