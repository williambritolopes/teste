...
class Type extends \AppBundle\Entity\Type implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Type' . "\0" . 'type', '' . "\0" . 'AppBundle\\Entity\\Type' . "\0" . 'created', '' . "\0" . 'AppBundle\\Entity\\Type' . "\0" . 'updated', '' . "\0" . 'AppBundle\\Entity\\Type' . "\0" . 'deleted', '' . "\0" . 'AppBundle\\Entity\\Type' . "\0" . 'id');
        }
