 ...
 */
class Status extends \EinsteinBundle\Entity\Status implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'EinsteinBundle\\Entity\\Status' . "\0" . 'status', '' . "\0" . 'EinsteinBundle\\Entity\\Status' . "\0" . 'created', '' . "\0" . 'EinsteinBundle\\Entity\\Status' . "\0" . 'updated', '' . "\0" . 'EinsteinBundle\\Entity\\Status' . "\0" . 'deleted', '' . "\0" . 'EinsteinBundle\\Entity\\Status' . "\0" . 'id');
        }
