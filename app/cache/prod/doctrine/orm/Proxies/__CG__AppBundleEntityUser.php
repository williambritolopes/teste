...
class User extends \AppBundle\Entity\User implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\User' . "\0" . 'name', '' . "\0" . 'AppBundle\\Entity\\User' . "\0" . 'nick', '' . "\0" . 'AppBundle\\Entity\\User' . "\0" . 'password', '' . "\0" . 'AppBundle\\Entity\\User' . "\0" . 'email', '' . "\0" . 'AppBundle\\Entity\\User' . "\0" . 'cellPhone', '' . "\0" . 'AppBundle\\Entity\\User' . "\0" . 'specialty', '' . "\0" . 'AppBundle\\Entity\\User' . "\0" . 'created', '' . "\0" . 'AppBundle\\Entity\\User' . "\0" . 'updated', '' . "\0" . 'AppBundle\\Entity\\User' . "\0" . 'deleted', '' . "\0" . 'AppBundle\\Entity\\User' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\User' . "\0" . 'type', '' . "\0" . 'AppBundle\\Entity\\User' . "\0" . 'gender');
        }
    ...
    public function setUpdated($update)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setUpdated', array($update));

        return parent::setUpdated($update);
    }
