...
class Gender extends \AppBundle\Entity\Gender implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Gender' . "\0" . 'gender', '' . "\0" . 'AppBundle\\Entity\\Gender' . "\0" . 'createdDate', '' . "\0" . 'AppBundle\\Entity\\Gender' . "\0" . 'updateDate', '' . "\0" . 'AppBundle\\Entity\\Gender' . "\0" . 'deletedDate', '' . "\0" . 'AppBundle\\Entity\\Gender' . "\0" . 'id');
        }
