...
class Message extends \AppBundle\Entity\Message implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Message' . "\0" . 'message', '' . "\0" . 'AppBundle\\Entity\\Message' . "\0" . 'createdDate', '' . "\0" . 'AppBundle\\Entity\\Message' . "\0" . 'updatedDate', '' . "\0" . 'AppBundle\\Entity\\Message' . "\0" . 'deletedDate', '' . "\0" . 'AppBundle\\Entity\\Message' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\Message' . "\0" . 'user', '' . "\0" . 'AppBundle\\Entity\\Message' . "\0" . 'status');
        }
