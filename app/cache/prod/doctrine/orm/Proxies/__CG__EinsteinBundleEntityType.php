 ...
 */
class Type extends \EinsteinBundle\Entity\Type implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'EinsteinBundle\\Entity\\Type' . "\0" . 'type', '' . "\0" . 'EinsteinBundle\\Entity\\Type' . "\0" . 'created', '' . "\0" . 'EinsteinBundle\\Entity\\Type' . "\0" . 'updated', '' . "\0" . 'EinsteinBundle\\Entity\\Type' . "\0" . 'deleted', '' . "\0" . 'EinsteinBundle\\Entity\\Type' . "\0" . 'id');
        }
