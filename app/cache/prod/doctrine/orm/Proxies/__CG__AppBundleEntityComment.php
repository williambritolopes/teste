...
class Comment extends \AppBundle\Entity\Comment implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Comment' . "\0" . 'comment', '' . "\0" . 'AppBundle\\Entity\\Comment' . "\0" . 'created', '' . "\0" . 'AppBundle\\Entity\\Comment' . "\0" . 'updated', '' . "\0" . 'AppBundle\\Entity\\Comment' . "\0" . 'deleted', '' . "\0" . 'AppBundle\\Entity\\Comment' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\Comment' . "\0" . 'user', '' . "\0" . 'AppBundle\\Entity\\Comment' . "\0" . 'status', '' . "\0" . 'AppBundle\\Entity\\Comment' . "\0" . 'content');
        }
