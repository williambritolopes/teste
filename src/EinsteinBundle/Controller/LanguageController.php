...
use EinsteinBundle\Entity\Language;
...
class LanguageController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $languages = $em->getRepository('EinsteinBundle:Language')->findAll();
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('EinsteinBundle\Form\LanguageType', $language);
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('einstein_language_show', array('id' => $language->getId()));
        }
    ...
    {
        $deleteForm = $this->createDeleteForm($language);
        $editForm = $this->createForm('EinsteinBundle\Form\LanguageType', $language);
        $editForm->handleRequest($request);

        if ($editForm->isSubmitted() && $editForm->isValid()) {
            $this->getDoctrine()->getManager()->flush();

            return $this->redirectToRoute('einstein_language_edit', array('id' => $language->getId()));
        }
    ...
    public function deleteAction(Request $request, Language $language)
    {
        ...
        return $this->redirectToRoute('einstein_language_index');
    }
    ...
    private function createDeleteForm(Language $language)
    {
        return $this->createFormBuilder()
            ->setAction($this->generateUrl('einstein_language_delete', array('id' => $language->getId())))
            ->setMethod('DELETE')
            ->getForm()
        ;
    }
