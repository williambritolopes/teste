...
use EinsteinBundle\Entity\Notification;
...
class NotificationController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $notifications = $em->getRepository('EinsteinBundle:Notification')->findAll();
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('EinsteinBundle\Form\NotificationType', $notification);
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('einstein_notification_show', array('id' => $notification->getId()));
        }
    ...
    {
        $deleteForm = $this->createDeleteForm($notification);
        $editForm = $this->createForm('EinsteinBundle\Form\NotificationType', $notification);
        $editForm->handleRequest($request);

        if ($editForm->isSubmitted() && $editForm->isValid()) {
            $this->getDoctrine()->getManager()->flush();

            return $this->redirectToRoute('einstein_notification_edit', array('id' => $notification->getId()));
        }
    ...
    public function deleteAction(Request $request, Notification $notification)
    {
        ...
        return $this->redirectToRoute('einstein_notification_index');
    }
    ...
    private function createDeleteForm(Notification $notification)
    {
        return $this->createFormBuilder()
            ->setAction($this->generateUrl('einstein_notification_delete', array('id' => $notification->getId())))
            ->setMethod('DELETE')
            ->getForm()
        ;
    }
